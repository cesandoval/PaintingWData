...
module.exports.uploadBlobToBucket = function(blob, datavoxelId, bucket, callback) {
  // var imgName = uuidv1() +'$$'+ datavoxelId.toString()+ '.png';
  var imgName = datavoxelId.toString()+ '.jpg';
  var data = {
    ACL: "public-read",
    Key: imgName, 
    Body: blob.buf,
