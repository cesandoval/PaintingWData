    ...
    render() {
        ...
        return(
            <div className="options--react">
                ...
                <div onClick={this.getScreenShot} style={{ cursor: 'pointer', position: 'absolute', width: '100%', textAlign: 'center', marginTop: '-27px',}}>
                    {
